...
class PDODb {
    ...
    public function connect() {
        ...
        if ($dbType == 'sqlite') {
            ...
            $connectionParams = array('host', 'dbname', 'port');
    ...
    private function buildInsertQuery($tableData) {
        ...
        $isInsert = in_array($this->queryType, array('REPLACE', 'INSERT'));
     ...
     */
    public static function getInstance($type, $host = null, $username = null, $password = null, $dbname = null, $port = null, $charset = null) {
        if (empty(self::$instance)) {
            new PDODb($type, $host, $username, $password, $dbname, $port, $charset);
        }
    ...
    public function get($tableName, $numRows = null, $columns = '*') {
        if (empty($columns)) {
            ...
            $column = ($columns == "*" ? "*" : "\"" . (is_array($columns) ? implode('", "', $columns) : $columns) . "\"");
        }
