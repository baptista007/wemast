				...
				<form id="form<?php echo $form_id ?>" action="<?php echo ($this->set_link()); ?>" method="get">
					<div class="row justify-content-center">
						...
						<div class="<?php echo $detail_page_class; ?>">
							...
							?>
									<small class="text-muted"> <?php print_lang('txt_records_of'); ?>  : <?php echo $record_position; ?> <?php print_lang('txt_of'); ?>  <?php echo $this->total_records; ?></small>
							...
							?>
									| <small class="text-muted"><?php print_lang('txt_page_of'); ?> : 
										...
										<?php print_lang('txt_of'); ?> <?php echo $numofpages; ?>
									</small>
							<?php 
								}
